...
export const config = {
    ...
    uiAutomationNavigationTimeout: parseInt(process.env.UI_AUTOMATION_NAVIGATION_TIMEOUT || '50000', 10),
    uiAutomationCommandTimeout: parseInt(process.env.UI_AUTOMATION_COMMAND_TIMEOUT || '30000', 10),
    cucumberCustomTimeout: parseInt(process.env.CUCUMBER_CUSTOM_TIMEOUT || '60000', 10),
};
